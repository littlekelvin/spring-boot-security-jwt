...
import com.kelvin.oocl.springsecurityjwt.security.vo.LoginRequest;
...
public class LoginProcessFilter extends AbstractAuthenticationProcessingFilter {
    private static Logger logger = LoggerFactory.getLogger(LoginProcessFilter.class);

    private AuthenticationSuccessHandler successHandler;
    private AuthenticationFailureHandler failureHandler;
    private ObjectMapper objectMapper;

    public LoginProcessFilter(String defaultProcessesUrl, AuthenticationSuccessHandler successHandler,
    ...
    public Authentication attemptAuthentication(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse)
        ...
        try {
            ...
            throw new AuthenticationServiceException("invalid request parameters");
        }
